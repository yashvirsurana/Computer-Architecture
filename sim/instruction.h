...
const instruction instructions[] =
  ...
  ,{ "   addi", NULL,     true,  1, 1, false, 0, 0, false, 1 }     // 01
  ...
  ,{ "   subi", NULL,     true,  2, 1, false, 0, 0, false, 1 }     // 08
  ,{ "    add", NULL,     true,  1, 0, false, 0, 0, false, 1 }     // 09
  ,{ "syscall", &sysc_op, false, 0, 0, false, 0, 0, false, 1 } };  // 0a
